...
<table id="dg" title="订单详情" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="true" data-options="pageSize:10"
       url="${pageContext.request.contextPath}/order/orderManager.do?orders="+ toolbar="#tb">
    <thead data-options="frozen:true">
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="pid" width="100" align="center">商品编号</th>
        <th field="orderId" width="100" align="center" hidden="true">订单id</th>
        <th field="count" width="200" align="center">数量</th>
        <th field="totlePrice" width="150" align="center">总价(人民币)</th>
        ...
        <table cellspacing="8px">
            <tr>
                ...
                <td><input type="text" id="pid" name="pid"
                           class="easyui-validatebox" required="true" readonly/>&nbsp;<font
                        color="red">*</font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>总价：</td>
                <td><input type="text" id="totlePrice" name="totlePrice"
                           class="easyui-validatebox" required="true"/>&nbsp;<font
                        color="red">*</font>
                </td>
            </tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var orders = urlObj.searchParams.get("orders");
        <%--$('#dg').url="${pageContext.request.contextPath}/order/orderManager.do?orders=" + orders;--%>
        $('#dg').datagrid('options').url = "${pageContext.request.contextPath}/order/orderManager.do?orders=" + orders;
        $('#dg').datagrid('load');
    });
        ...
        $.messager
            .confirm(
                ...
                function (r) {
                    if (r) {
                        $.post(
                            "${pageContext.request.contextPath}/order/managerDeleteOrder.do",
                            {
                                ids: ids
                            },
                            function (result) {
    ...
    function openArticleModifyDialog() {
        ...
        url = "${pageContext.request.contextPath}/order/save.do?orderId="
            + row.orderId;
    }
